...
const MapSection = () => {
    return (
        <section className="py-16 sm:py-20 bg-primary-50" id="map" aria-label="ที่ตั้งร้าน">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-10 sm:mb-12">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">แนะนำร้านเกื้อกูลกัน</h2>
                    <p className="mt-3 sm:mt-4 text-sm sm:text-lg text-gray-700 font-medium px-2">ที่อยู่ร้าน: 26/16-19 หมู่ 10 ต.วัดไทรย์ , Nakhon Sawan, Thailand, 60000</p>
                    <p className="mt-2 text-xs sm:text-sm text-gray-500">แวะมาเลือกชมสินค้าได้ที่หน้าร้าน พร้อมที่จอดรถสะดวกสบาย</p>
                </div>
