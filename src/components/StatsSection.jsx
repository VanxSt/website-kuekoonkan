...
const StatsSection = () => {
    return (
        <section className="bg-primary-600 py-12 sm:py-16 text-white" aria-label="ตัวเลขสำคัญ">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 text-center lg:divide-x divide-primary-500/50">
                    <div>
